...
FROM '/Users/DataScience/Documents/GDS_WeeklyNotes/week_1/day3-SQL/SQL_I/student_data.csv'
DELIMITER ',' CSV HEADER;

COPY term_gpa(id,term,gpa)
FROM '/Users/DataScience/Documents/GDS_WeeklyNotes/week_1/day3-SQL/SQL_I/term_gpa_data.csv'
DELIMITER ',' CSV HEADER;

COPY degrees(id,term,degree)
FROM '/Users/DataScience/Documents/GDS_WeeklyNotes/week_1/day3-SQL/SQL_I/degrees_data.csv' 
DELIMITER ',' CSV HEADER;
